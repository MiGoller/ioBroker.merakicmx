            ...
            if (processDevice) {
                ...
                if (device.location) {
                    ...
                    if (track_location_wifi) {
                        ...
                        await setStateReadOnlyValue(`${dpDevice}.gps-coordinates`, "gps-coordinates", "text", "value.gps", `${lat},${lng}`, true);
                    }
    ...
    if (data.observations) {
        for (let o in data.observations) {
            ...
            if (processDevice) {
                ...
                //  Update device information.
                //  Device and radio data
                await setStateReadOnlyValue(`${dpDevice}.clientMac`, "clientMac", "text", "value", bleDevice.clientMac, true);
                ...
                //     await setStateReadOnlyValue(`${dpDevice}.gps-coordinates`, "gps-coordinates", "text", "value.gps", `${Number(bleDevice.location.lat || "0")},${Number(bleDevice.location.lng || "0")}`, true);
                // }
